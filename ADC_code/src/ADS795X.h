...
public:
    ...
    boolean initCommunication(SPIClass &spiPort = SPI, uint32_t clock = SPI_CLOCK_DIV4, BitOrder bitOrder = MSBFIRST, uint8_t dataMode = SPI_MODE0);
